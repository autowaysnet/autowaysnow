...
namespace AutoWaysNetworkLib\Exceptions;
...
class ApiException extends \Exception implements Exception
{
     ...
     * HTTP request
     *
     * @var \AutoWaysNetworkLib\Http\HttpRequest
     */
    private $request;
     ...
     * HTTP response
     *
     * @var \AutoWaysNetworkLib\Http\HttpResponse|null
     */
    private $response;

    /**
     * @param string $reason the reason for raising an exception
     * @param \AutoWaysNetworkLib\Http\HttpRequest $request
     */
